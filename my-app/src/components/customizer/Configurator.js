...
const Configurator = () => {
    ...
    return (
        ...
        <div className="some-info-customizer">
            <h1 className="perso-h1" style={{color: '#E88ED3'}}>PERSONALIZATOR</h1>
            <h5>Wybierz element, który chcesz zmodyfikować z listy rozwijanej po prawej, a następnie kliknij na jeden z kolorów by zastosować go na danym elemencie. Wybrany przez Ciebie aktualnie kolor oznaczony jest różowym kolorem.</h5>
            <h5>Legenda elementów:</h5>
            <ul className="legend">
                <li><b>Baza klawiatury</b> - podstawka na której znajduje się klawiatura
                <div className="d-flex justify-content-center">
                    <img src='img/40_1_c2.png' alt='base' className='img-fluid img-legend'/>
                </div>
                
                </li>
                <li><b>Środek bazy klawiatury</b> - środek podstawki (miejsce w którym umieszczone są klawisze)
                <div className="d-flex justify-content-center"><img src='img/40_1_c2.png' alt='base' className='img-fluid img-legend'/></div>
                
                </li>
                <li><b>Klawisze główne</b> - to te klawisze, których jest najwięcej
                <div className="d-flex justify-content-center"><img src='img/40_1_c2.png' alt='base' className='img-fluid img-legend'/></div>
                </li>
                <li><b>Klawisze dodatkowe</b> - to pozostałe klawisze 
                <div className="d-flex justify-content-center"><img src='img/40_1_c2.png' alt='base' className='img-fluid img-legend'/></div>
                </li>
            </ul>
        </div>
        <div className="configurator">
            <select class="form-select" value={selectedOption} onChange={handleSelectChange}>
                <option selected value="1">Baza klawiatury</option>
            ...
            )}
            {
                selectedOption === '2' && (
                    <div className="configurator__section keyb-inside-base">
                        <div className="configurator__section__title">Środek bazy klawiatury</div>
                        <div className="configurator__section__values">
                            {colorsForKeyboard.map((item, index) => (
                                <div
                                    key={index}
            ...
            }
            {
                selectedOption === '4' && (
                    <div className="configurator__section keyb-keys2">
                        <div className="configurator__section__title">Klawisze dodatkowe</div>
                        <div className="configurator__section__values">
                            {colorsForKeyboard.map((item, index) => (
                                <div
                                    key={index}
        ...
        <div className="configurator2">
            <button className='btn'><FontAwesomeIcon icon={faCartPlus} size="2x"/></button>
        </div>
        </>
    );
};
